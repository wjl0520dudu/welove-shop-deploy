...
from app.domain.knowledge.models import ChunkMetadata, DocumentChunk, MetadataFilter, SearchRequest, SearchResult
...
def document_to_result(doc: Document, score: float = 0.0) -> SearchResult:
    from app.domain.knowledge.models import ChunkMetadata
    return SearchResult(
